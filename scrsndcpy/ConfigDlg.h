...
public:
	...
	BEGIN_DDX_MAP(ConfigDlg)
		...
		DDX_INT_RANGE(IDC_EDIT_VIDEO_BUFFER_MS, m_tempConfig.videoBuffer_ms,  0u, 1000u)
		DDX_CHECK(IDC_CHECK_TURN_SCREEN_OFF, m_tempConfig.turnScreenOff)
		DDX_CHECK(IDC_CHECK_NO_RESIZE, m_tempConfig.noResize)
		...
		DDX_CHECK(IDC_CHECK_TOGGLE_MUTE_REVERSE, m_tempConfig.toggleMuteReverse)
	END_DDX_MAP()
